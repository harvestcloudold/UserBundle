...
namespace HarvestCloud\UserBundle\Entity;
...
class User extends BaseUser
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\HarvestCloud\CoreBundle\Entity\Profile", inversedBy="usersAsDefaultProfile", cascade={"persist"})
     * @ORM\JoinColumn(name="default_profile_id", referencedColumnName="id")
     */
    protected $defaultProfile;

    /**
     * @ORM\ManyToOne(targetEntity="\HarvestCloud\CoreBundle\Entity\Profile", inversedBy="usersAsCurrentProfile", cascade={"persist"})
     * @ORM\JoinColumn(name="current_profile_id", referencedColumnName="id")
     */
    protected $currentProfile;

    /**
     * @ORM\ManyToMany(targetEntity="\HarvestCloud\CoreBundle\Entity\Profile", inversedBy="users")
